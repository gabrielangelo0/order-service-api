...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      OrderService: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.OrderServiceFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.OrderServiceAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type OrderServiceOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "description" | "client" | "priority" | "category" | "technician" | "dueDate" | "estimatedHours" | "notes" | "status", ExtArgs["result"]["orderService"]>
  ...
  export interface OrderServiceDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more OrderServices that matches the filter.
     * @param {OrderServiceFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const orderService = await prisma.orderService.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: OrderServiceFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a OrderService.
     * @param {OrderServiceAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const orderService = await prisma.orderService.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: OrderServiceAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface OrderServiceFieldRefs {
    ...
    readonly title: FieldRef<"OrderService", 'String'>
    readonly description: FieldRef<"OrderService", 'String'>
    readonly client: FieldRef<"OrderService", 'String'>
    readonly priority: FieldRef<"OrderService", 'String'>
    readonly category: FieldRef<"OrderService", 'String'>
    readonly technician: FieldRef<"OrderService", 'String'>
    readonly dueDate: FieldRef<"OrderService", 'DateTime'>
    readonly estimatedHours: FieldRef<"OrderService", 'Int'>
    readonly notes: FieldRef<"OrderService", 'String'>
    readonly status: FieldRef<"OrderService", 'String'>
  }
  ...
  /**
   * OrderService findRaw
   */
  export type OrderServiceFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * OrderService aggregateRaw
   */
  export type OrderServiceAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type OrderServiceWhereInput = {
    ...
    title?: StringFilter<"OrderService"> | string
    description?: StringFilter<"OrderService"> | string
    client?: StringFilter<"OrderService"> | string
    priority?: StringFilter<"OrderService"> | string
    category?: StringFilter<"OrderService"> | string
    technician?: StringFilter<"OrderService"> | string
    dueDate?: DateTimeFilter<"OrderService"> | Date | string
    estimatedHours?: IntFilter<"OrderService"> | number
    notes?: StringFilter<"OrderService"> | string
    status?: StringFilter<"OrderService"> | string
  }
  ...
  export type OrderServiceOrderByWithAggregationInput = {
    ...
    _avg?: OrderServiceAvgOrderByAggregateInput
    _max?: OrderServiceMaxOrderByAggregateInput
    _min?: OrderServiceMinOrderByAggregateInput
    _sum?: OrderServiceSumOrderByAggregateInput
  }
  ...
  export type OrderServiceScalarWhereWithAggregatesInput = {
    ...
    title?: StringWithAggregatesFilter<"OrderService"> | string
    description?: StringWithAggregatesFilter<"OrderService"> | string
    client?: StringWithAggregatesFilter<"OrderService"> | string
    priority?: StringWithAggregatesFilter<"OrderService"> | string
    category?: StringWithAggregatesFilter<"OrderService"> | string
    technician?: StringWithAggregatesFilter<"OrderService"> | string
    dueDate?: DateTimeWithAggregatesFilter<"OrderService"> | Date | string
    estimatedHours?: IntWithAggregatesFilter<"OrderService"> | number
    notes?: StringWithAggregatesFilter<"OrderService"> | string
    status?: StringWithAggregatesFilter<"OrderService"> | string
  }
